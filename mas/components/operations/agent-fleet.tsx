...
import { ArrowRight, Power, Radar } from "lucide-react";
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  aria-label={`Kontrol lokal untuk ${agent.name}`}
                  title="Kontrol lokal"
                >
              ...
              <div className="mt-5 grid gap-3 md:grid-cols-2">
                <Meta label="Tugas utama" value={summary.task} />
                <Meta label="Input" value={summary.input} />
                <Meta label="Output" value={summary.output} />
                <Meta label="Fallback" value={summary.fallback} />
              </div>

              <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-white/10 pt-4">
                <p className="text-xs font-semibold text-slate-400">Kontrol lokal untuk mode pratinjau.</p>
                <button
                  type="button"
                  onClick={() => onSelectAgent(agent.id)}
